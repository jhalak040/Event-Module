...
@Entity
@Cacheable
@Table(name = "REGISTRATION_DISCOUNT")
public class Discount extends AuditableModel {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "REGISTRATION_DISCOUNT_SEQ")
	@SequenceGenerator(name = "REGISTRATION_DISCOUNT_SEQ", sequenceName = "REGISTRATION_DISCOUNT_SEQ", allocationSize = 1)
	private Long id;
